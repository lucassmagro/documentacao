...
const TYPES: Record<
  CalloutType,
  { emoji: string; border: string; bg: string; label: string }
> = {
  nota: { emoji: '📝', border: '#71717a', bg: 'rgba(113,113,122,0.12)', label: 'Nota' },
  info: { emoji: 'ℹ️', border: '#3b82f6', bg: 'rgba(59,130,246,0.12)', label: 'Info' },
  dica: { emoji: '💡', border: '#22c55e', bg: 'rgba(34,197,94,0.12)', label: 'Dica' },
  aviso: { emoji: '⚠️', border: '#f59e0b', bg: 'rgba(245,158,11,0.12)', label: 'Aviso' },
  erro: { emoji: '⛔', border: '#ef4444', bg: 'rgba(239,68,68,0.12)', label: 'Erro' }
}
...
export function Callout({
  ...
  return (
    <div style={box} role="note">
      <span aria-hidden style={{ fontSize: '1.1rem', lineHeight: 1.5 }}>
        {t.emoji}
      </span>
